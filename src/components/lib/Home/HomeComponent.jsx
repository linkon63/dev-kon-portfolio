...
const HomeComponent = () => {
    ...
    return (
        <section className=''>
            ...
            <header className='row m-0 p-0 w-100 headerSection'
            ...
            >
                ...
                >
                    <div className="h-100">
                        <div className="col h-25 row align-items-center" style={{ visibility: visible }} >
                            <div className='col h-100 d-flex align-items-end'>
                                <Text inComing={<h1 className='fw-bold text-warning'>Javascript</h1>} />
                            </div>
                            <div className='col m-0 p-0'>
                                <h1 className='d-flex'>
                                    <span style={{ color: '#3c823b' }}>
                                        Node
                                    </span>
                        ...
                        <div className="col h-25 d-flex align-items-start" style={{ visibility: visible }} >
                            <div className='col h-100 d-flex align-items-start'>
                                <div>
                                    <Text inComing={<h1 className='fw-bold' style={{ color: '#3675ab' }}>Python</h1>} />
                                    <Text inComing={<h6 className='fw-bold ms-5' style={{ color: 'red' }}>React Native</h6>} />
                                </div>
                            </div>
                            <div className='col m-0 p-0'>
                                {/* carousel */}
